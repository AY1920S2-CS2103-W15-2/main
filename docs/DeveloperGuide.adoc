...
Scenario 2. If the application has been `finalised` and the user tries to do CRUD operations to the `attributes` and `questions`,

Scenario 3 (Ideal Scenario). If the application has not been `finalised` and the user tries to do CRUD operations to the `attributes` and `questions`.

Scenario 4 (Ideadl Scenario). If the application has been `finalised` and the user tries to interview an interviewee,
